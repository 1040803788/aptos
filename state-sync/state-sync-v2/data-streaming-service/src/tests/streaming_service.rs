...
fn create_streaming_client_and_service() -> StreamingServiceClient {
    create_streaming_client_and_spawn_service(false, false, false)
}

fn create_streaming_client_and_service_with_data_delay() -> StreamingServiceClient {
    create_streaming_client_and_spawn_service(true, false, false)
}

fn create_streaming_client_and_service_with_chunk_limits() -> StreamingServiceClient {
    create_streaming_client_and_spawn_service(false, true, true)
}

pub fn create_streaming_client_and_spawn_service(
